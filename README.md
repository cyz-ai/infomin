...
where $L$ is some loss (e.g. classification loss) and $I$ is the mutual information. This objective is ubiquitous in algorithmic fairness, invariance, disentangled representation learning, domain adaptation, etc.
